...
dt=(device_xiaomi_beryllium device_xiaomi_sdm845-common)
vt=(vendor_xiaomi_beryllium)
...
# Device Trees
gc RadiantDevices/"${dt[0]}" device/xiaomi/beryllium 1 twelve
gc RadiantDevices/"${dt[1]}" device/xiaomi/sdm845-common 1 twelve

# Vendor Trees
gc RadiantDevices/"${vt[0]}" vendor/xiaomi 1 twelve
