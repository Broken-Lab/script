...
if [[ $ROM -eq 1 ]]
then
  echo -e "Creating Project Radiant Directory"
  mkdir radiant && cd radiant
  Syncing Radiant Sources
...
then
  ...
  git clone https://github.com/resist15/device_xiaomi_sdm845-common -b twelve device/xiaomi/sdm845-common
  git clone --depth 1 https://github.com/resist15/vendor_xiaomi_beryllium -b twelve vendor/xiaomi          
  git clone --depth 1 -b twelve https://github.com/PainKiller3/kernel_xiaomi_sdm845.git kernel/xiaomi/sdm845
